const CACHE = 'hotaru-shell-v7';
const APP_SHELL = [
  './','./index.html','./style.css?v=1.0.0','./enhancements.css?v=1.3.0','./content-enhancements.css?v=1.0.0','./js/features/guide-ui.css?v=1.0.0','./app.js?v=1.0.0','./enhancements.js?v=1.4.0','./content-enhancements.js?v=1.0.0','./js/features/guide-loader.js?v=1.0.0','./manifest.json',
  './js/core/state.js','./js/core/cache.js','./js/data/game-data.js','./js/data/enka.js','./js/data/character-reference.js',
  './js/features/build-engine.js','./js/features/farming.js','./js/features/taxonomy.js','./js/features/interactive-map.js','./js/features/content-media.js','./js/features/guide-engine.js','./js/features/guide-ui.js',
