...
const APP_SHELL = [
  './','./index.html','./style.css?v=1.8.1','./css/enhancements.css?v=1.4.0','./css/content-enhancements.css?v=1.0.0','./css/guide-ui.css?v=1.4.0','./css/exploration-ui.css?v=1.0.0','./css/roster-ui.css?v=1.0.0','./css/navigation-refresh.css?v=1.1.0','./css/roster-sections-team-filter.css?v=1.3.0','./js/pwa-update.js?v=1.1.1','./app.js?v=1.12.1','./js/enhancements.js?v=1.7.0','./js/content-enhancements.js?v=1.2.0','./js/features/guide-loader.js?v=1.2.0','./js/features/progression-calculator-ui.js?v=1.0.0','./js/features/navigation-refresh.js?v=1.2.0','./js/features/roster-sections-team-filter.js?v=1.3.2','./js/features/mobile-sync-ui.js?v=1.1.0','./js/features/aloy-reviewed-bootstrap.js?v=1.0.1','./js/features/team-community-bootstrap.js?v=1.1.1','./js/features/flexible-pair-ui.js?v=1.0.4','./js/features/character-ownership-filter.js?v=1.0.0','./js/features/smart-team-mobile-controller.js?v=1.0.6','./js/features/smart-team-results-pagination.js?v=1.2.2&hotfix=52','./tools/hotaru-hoyolab-export.user.js',
  './manifest.json',
