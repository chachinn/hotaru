const CACHE = 'hotaru-shell-v36';
const PREVIOUS_CACHE = 'hotaru-shell-v35';
// Migration lineage for release QA/history only: hotaru-shell-v26 → hotaru-shell-v27 → hotaru-shell-v28 → hotaru-shell-v29 → hotaru-shell-v30 → hotaru-shell-v31 → hotaru-shell-v32 → hotaru-shell-v33 → hotaru-shell-v34 → hotaru-shell-v35 → hotaru-shell-v36.
const APP_SHELL = [
  './','./index.html','./style.css?v=1.8.0','./css/enhancements.css?v=1.4.0','./css/content-enhancements.css?v=1.0.0','./css/guide-ui.css?v=1.3.0','./css/exploration-ui.css?v=1.0.0','./css/roster-ui.css?v=1.0.0','./css/navigation-refresh.css?v=1.1.0','./css/roster-sections-team-filter.css?v=1.0.0','./js/pwa-update.js?v=1.0.0','./app.js?v=1.12.0','./js/enhancements.js?v=1.7.0','./js/content-enhancements.js?v=1.2.0','./js/features/guide-loader.js?v=1.1.0','./js/features/progression-calculator-ui.js?v=1.0.0','./js/features/navigation-refresh.js?v=1.2.0','./js/features/mobile-sync-ui.js?v=1.1.0','./js/features/team-community-bootstrap.js?v=1.0.1','./js/features/flexible-pair-ui.js?v=1.0.1','./js/features/roster-sections-team-filter.js?v=1.0.1','./js/features/character-ownership-filter.js?v=1.0.0','./tools/hotaru-hoyolab-export.user.js',
  './manifest.json',
