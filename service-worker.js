const CACHE = 'hotaru-shell-v1';
const APP_SHELL = [
  './','./index.html','./style.css?v=1.0.0','./app.js?v=1.0.0','./manifest.json',
  './js/core/state.js','./js/core/cache.js','./js/data/game-data.js','./js/data/enka.js',
  './js/features/build-engine.js','./js/features/farming.js',
...
const NEVER_CACHE = ['enka.network/api/','api/uid/'];
