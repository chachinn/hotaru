...
assert.ok(sw.includes('hotaru-shell-v24'));assert.ok(sw.includes('js/data/team-profiles/index.js'));assert.ok(sw.includes('js/features/team-scoring.js'));assert.ok(sw.includes('js/features/roster-team-matcher.js'));assert.ok(index.includes('app.js?v=1.10.0'));assert.ok(index.includes('style.css?v=1.7.0'));
