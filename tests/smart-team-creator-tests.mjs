...
assert.ok(sw.includes('hotaru-shell-v22'));assert.ok(sw.includes('js/data/team-profiles/index.js'));assert.ok(sw.includes('js/features/team-scoring.js'));assert.ok(sw.includes('js/features/roster-team-matcher.js'));assert.ok(index.includes('app.js?v=1.8.0'));assert.ok(index.includes('style.css?v=1.5.0'));
