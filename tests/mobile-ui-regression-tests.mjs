...
assert.match(sw,/const CACHE = 'hotaru-shell-v30'/);assert.match(sw,/const PREVIOUS_CACHE = 'hotaru-shell-v29'/);assert.match(sw,/style\.css\?v=1\.8\.0/);assert.match(sw,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(sw,/app\.js\?v=1\.13\.0/);
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
assert.match(index,/style\.css\?v=1\.8\.0/);assert.match(index,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(index,/app\.js\?v=1\.13\.0/);
