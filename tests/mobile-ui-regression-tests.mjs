...
assert.match(sw,/const CACHE = 'hotaru-shell-v44'/);assert.match(sw,/const PREVIOUS_CACHE = 'hotaru-shell-v43'/);assert.match(sw,/style\.css\?v=1\.8\.0/);assert.match(sw,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(sw,/css\/roster-sections-team-filter\.css\?v=1\.2\.2/);assert.match(sw,/app\.js\?v=1\.12\.0/);assert.match(sw,/team-community-bootstrap\.js\?v=1\.0\.2/);assert.match(sw,/smart-team-mobile-controller\.js\?v=1\.0\.3/);
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
assert.match(index,/style\.css\?v=1\.8\.0/);assert.match(index,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(index,/css\/roster-sections-team-filter\.css\?v=1\.2\.2/);assert.match(index,/app\.js\?v=1\.12\.0/);assert.match(index,/team-community-bootstrap\.js\?v=1\.0\.2/);assert.match(index,/smart-team-mobile-controller\.js\?v=1\.0\.3/);
