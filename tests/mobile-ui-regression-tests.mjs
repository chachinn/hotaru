...
assert.match(sw,/const CACHE = 'hotaru-shell-v37'/);assert.match(sw,/const PREVIOUS_CACHE = 'hotaru-shell-v36'/);assert.match(sw,/style\.css\?v=1\.8\.0/);assert.match(sw,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(sw,/app\.js\?v=1\.12\.0/);
