...
assert.match(sw,/const CACHE = 'hotaru-shell-v47'/);assert.match(sw,/const PREVIOUS_CACHE = 'hotaru-shell-v46'/);assert.match(sw,/style\.css\?v=1\.8\.1/);assert.match(sw,/css\/guide-ui\.css\?v=1\.4\.0/);assert.match(sw,/css\/roster-sections-team-filter\.css\?v=1\.3\.0/);assert.match(sw,/app\.js\?v=1\.12\.1/);assert.match(sw,/team-community-bootstrap\.js\?v=1\.1\.1/);assert.match(sw,/smart-team-mobile-controller\.js\?v=1\.0\.6/);
