...
assert.match(sw,/const CACHE = 'hotaru-shell-v30'/);assert.match(sw,/const PREVIOUS_CACHE = 'hotaru-shell-v29'/);assert.match(sw,/style\.css\?v=1\.8\.0/);assert.match(sw,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(sw,/app\.js\?v=1\.12\.0/);
