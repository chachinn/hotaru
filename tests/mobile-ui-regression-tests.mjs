...
assert.match(sw,/hotaru-shell-v24/);assert.match(sw,/style\.css\?v=1\.7\.0/);assert.match(sw,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(sw,/app\.js\?v=1\.10\.0/);
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
assert.match(index,/style\.css\?v=1\.7\.0/);assert.match(index,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(index,/app\.js\?v=1\.10\.0/);
