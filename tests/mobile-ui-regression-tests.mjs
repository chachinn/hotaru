...
assert.match(sw,/const CACHE = 'hotaru-shell-v39'/);assert.match(sw,/const PREVIOUS_CACHE = 'hotaru-shell-v38'/);assert.match(sw,/style\.css\?v=1\.8\.0/);assert.match(sw,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(sw,/css\/roster-sections-team-filter\.css\?v=1\.0\.1/);assert.match(sw,/app\.js\?v=1\.12\.0/);
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
assert.match(index,/style\.css\?v=1\.8\.0/);assert.match(index,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(index,/css\/roster-sections-team-filter\.css\?v=1\.0\.1/);assert.match(index,/app\.js\?v=1\.12\.0/);
console.log('Hotaru mobile UI + Smart Team phone layout + rarity + same-weapon-type regression QA passed.');