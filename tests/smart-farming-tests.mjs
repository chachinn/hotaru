...
assert.ok(app.includes('Build Farm Today Plan'));assert.ok(app.includes('Farm Today'));assert.ok(app.includes('Resin Planner'));assert.ok(app.includes('generate-smart-farm'));assert.ok(app.includes('getMapFilterOptions'));assert.ok(sw.includes('hotaru-shell-v26'));assert.ok(sw.includes('js/features/farm-planner.js'));assert.ok(sw.includes('app.js?v=1.12.0'));assert.ok(index.includes('app.js?v=1.12.0'));assert.ok(index.includes('style.css?v=1.8.1'));
