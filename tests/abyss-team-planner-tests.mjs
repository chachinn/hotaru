...
assert.ok(sw.includes("const CACHE = 'hotaru-shell-v45'"));assert.ok(sw.includes("PREVIOUS_CACHE = 'hotaru-shell-v44'"));assert.ok(sw.includes('js/features/abyss-team-planner.js'));assert.ok(sw.includes('smart-team-mobile-controller.js?v=1.0.4'));assert.ok(index.includes('app.js?v=1.12.0'));assert.ok(index.includes('style.css?v=1.8.1'));assert.ok(index.includes('smart-team-mobile-controller.js?v=1.0.4'));
