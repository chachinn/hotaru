...
const app=fs.readFileSync(new URL('../app.js',import.meta.url),'utf8'),controller=fs.readFileSync(new URL('../js/features/smart-team-mobile-controller.js',import.meta.url),'utf8'),sw=fs.readFileSync(new URL('../service-worker.js',import.meta.url),'utf8'),index=fs.readFileSync(new URL('../index.html',import.meta.url),'utf8'),style=fs.readFileSync(new URL('../style.css',import.meta.url),'utf8'),enhancements=fs.readFileSync(new URL('../js/features/smart-team-v48-enhancements.js',import.meta.url),'utf8'),bootstrap=fs.readFileSync(new URL('../js/features/team-community-bootstrap.js',import.meta.url),'utf8');
...
assert.ok(style.includes('.abyss-team-grid'));assert.ok(style.includes('.abyss-next'));assert.ok(enhancements.includes('Build next for this side'),'stable-shell enhancement must add per-side Materials recommendations without replacing the proven controller');
