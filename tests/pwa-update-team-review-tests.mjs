...
assert.match(sw,/app\.js\?v=1\.12\.1/,'The fresh shell must cache the cache-busted app bootstrap');
...
console.log('Hotaru v47 stale-PWA recovery + reviewed-team status regression QA passed.');