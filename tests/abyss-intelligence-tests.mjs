...
assert.ok(sw.includes('hotaru-shell-v25'));assert.ok(sw.includes('js/data/abyss-cycle.js'));assert.ok(sw.includes('js/features/abyss-intelligence.js'));assert.ok(index.includes('app.js?v=1.11.0'));assert.ok(index.includes('style.css?v=1.8.0'));
