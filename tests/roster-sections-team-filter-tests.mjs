...
assert.match(index,/roster-sections-team-filter\.css\?v=1\.2\.2/); assert.match(index,/roster-sections-team-filter\.js\?v=1\.2\.0/);
assert.match(index,/smart-team-mobile-controller\.js\?v=1\.0\.3/); assert.match(index,/smart-team-results-pagination\.js\?v=1\.1\.0/);
assert.match(sw,/const CACHE = 'hotaru-shell-v44'/); assert.match(sw,/PREVIOUS_CACHE = 'hotaru-shell-v43'/);
assert.match(sw,/smart-team-results-pagination\.js\?v=1\.1\.0/); assert.match(sw,/roster-sections-team-filter\.css\?v=1\.2\.2/);
