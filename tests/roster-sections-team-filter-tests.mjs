...
assert.match(ui,/data-hotaru-roster-section/);
...
assert.match(css,/\.hotaru-roster-tabs button\.active/);
...
console.log('Hotaru clean Roster sections + team utility filter QA passed.');
