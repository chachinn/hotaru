...
assert.match(index,/smart-team-mobile-controller\.js\?v=1\.0\.6/); assert.match(index,/smart-team-results-pagination\.js\?v=1\.2\.2&hotfix=52/);
assert.match(sw,/const CACHE = 'hotaru-shell-v48'/); assert.match(sw,/PREVIOUS_CACHE = 'hotaru-shell-v47'/);
assert.match(sw,/smart-team-results-pagination\.js\?v=1\.2\.2&hotfix=52/); assert.match(sw,/roster-sections-team-filter\.css\?v=1\.3\.0/); assert.match(sw,/roster-sections-team-filter\.js\?v=1\.3\.2/);
assert.match(updater,/RELEASE='v48'/);
