...
assert.match(index,/smart-team-mobile-controller\.js\?v=1\.0\.4/); assert.match(index,/smart-team-results-pagination\.js\?v=1\.2\.1/);
assert.match(sw,/const CACHE = 'hotaru-shell-v45'/); assert.match(sw,/PREVIOUS_CACHE = 'hotaru-shell-v44'/);
assert.match(sw,/smart-team-results-pagination\.js\?v=1\.2\.1/); assert.match(sw,/roster-sections-team-filter\.css\?v=1\.3\.0/);
assert.match(updater,/RELEASE='v45'/);
