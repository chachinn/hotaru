...
assert.match(sw,/enka\.network\/api\//);assert.match(sw,/NEVER_CACHE/);assert.match(sw,/hotaru-shell-v7/);assert.match(sw,/genshin-impact-map\.appsample\.com/);assert.match(sw,/MadeBaruna\/paimon-moe/);assert.match(sw,/content-enhancements\.js\?v=1\.0\.0/);assert.match(sw,/js\/features\/content-media\.js/);assert.match(sw,/guide-loader\.js\?v=1\.0\.0/);
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');assert.match(index,/type="module"/);assert.match(index,/Hotaru/);assert.match(index,/enhancements\.js\?v=1\.4\.0/);assert.match(index,/enhancements\.css\?v=1\.3\.0/);assert.match(index,/content-enhancements\.js\?v=1\.0\.0/);assert.match(index,/content-enhancements\.css\?v=1\.0\.0/);assert.match(index,/guide-loader\.js\?v=1\.0\.0/);assert.match(index,/guide-ui\.css\?v=1\.0\.0/);
