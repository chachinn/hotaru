...
assert.match(sw,/enka\.network\/api\//);assert.match(sw,/NEVER_CACHE/);assert.match(sw,/hotaru-shell-v15/);assert.match(sw,/genshin-impact-map\.appsample\.com/);assert.match(sw,/MadeBaruna\/paimon-moe/);assert.match(sw,/js\/content-enhancements\.js\?v=1\.2\.0/);assert.match(sw,/js\/features\/content-media\.js/);assert.match(sw,/js\/data\/map-registry\.js/);assert.match(sw,/guide-loader\.js\?v=1\.1\.0/);assert.match(sw,/css\/enhancements\.css\?v=1\.3\.0/);assert.match(sw,/css\/guide-ui\.css\?v=1\.2\.0/);
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');assert.match(index,/type="module"/);assert.match(index,/Hotaru/);assert.match(index,/js\/enhancements\.js\?v=1\.5\.0/);assert.match(index,/css\/enhancements\.css\?v=1\.3\.0/);assert.match(index,/js\/content-enhancements\.js\?v=1\.2\.0/);assert.match(index,/css\/content-enhancements\.css\?v=1\.0\.0/);assert.match(index,/guide-loader\.js\?v=1\.1\.0/);assert.match(index,/css\/guide-ui\.css\?v=1\.2\.0/);
