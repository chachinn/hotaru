...
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');assert.match(index,/guide-loader\.js\?v=1\.1\.0/);assert.match(index,/css\/guide-ui\.css\?v=1\.3\.0/);assert.match(index,/css\/exploration-ui\.css\?v=1\.0\.0/);assert.match(index,/css\/roster-ui\.css\?v=1\.0\.0/);
