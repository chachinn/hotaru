...
assert.match(guideEngine,/members\.length!==4\\|_llmembers\.some/,'Sourced guide teams must be complete four-character teams');
assert.match(guideEngine,/Kaedehara Kazuha/,'Kazeha alias should resolve against canonical catalogue naming');
