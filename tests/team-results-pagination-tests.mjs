...
const css=fs.readFileSync('css/smart-team-v47.css','utf8');
...
assert.match(index,/smart-team-results-pagination\.js\?v=1\.2\.1/);assert.match(sw,/smart-team-results-pagination\.js\?v=1\.2\.1/);
