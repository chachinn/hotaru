...
assert.ok(sw.includes('hotaru-shell-v26'));assert.ok(sw.includes('app.js?v=1.12.1'));assert.ok(sw.includes('style.css?v=1.8.1'));assert.match(state,/farmServer:'Asia'/);
