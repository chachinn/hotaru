...
assert.ok(sw.includes('hotaru-shell-v25'));assert.ok(sw.includes('js/features/daily-dashboard.js'));assert.ok(index.includes('app.js?v=1.11.0'));assert.ok(index.includes('style.css?v=1.8.0'));
