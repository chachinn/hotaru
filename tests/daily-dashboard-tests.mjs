...
assert.ok(sw.includes('hotaru-shell-v26'));assert.ok(sw.includes('js/features/daily-dashboard.js'));assert.ok(index.includes('app.js?v=1.12.0'));assert.ok(index.includes('style.css?v=1.8.0'));
