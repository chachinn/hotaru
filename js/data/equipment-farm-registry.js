export const ARTIFACT_FARM_INFO={
  ...
  'Thundering Fury':{source:'Midsummer Courtyard, Starsnatch Cliff; also Artifact Strongbox',region:'Mondstadt',kind:'Artifact Domain / Artifact Strongbox'},
...
export const WEAPON_FARM_INFO={
  ...
  'Absolution':{source:'Limited Weapon Event Wishes when featured',kind:'Limited 5-star signature Sword'},
  'The Black Sword':{source:'Battle Pass / Gnostic Hymn weapon selection',kind:'Battle Pass Sword'},
  'Finale of the Deep':{source:'Forge after obtaining the Fontaine forging diagram and required Sword Billet/materials',kind:'Craftable Sword'},
  'Calamity of Eshu':{source:'Limited event reward; currently unavailable if the event was missed',kind:'Limited event Sword'},
