const KQM='https://keqingmains.com/q/iansan-quickguide/';
const IV='https://www.icy-veins.com/genshin-impact/iansan-team-guide';
const source={label:'Iansan reviewed team theorycraft',url:KQM,type:'Reviewed theorycraft',platform:'Guide',reviewedAt:'2026-08-24',links:[{label:'Current Iansan team cross-check',url:IV,type:'Current team guide',platform:'Guide',reviewedAt:'2026-08-24'}]};
const team=(id,name,members,reaction,why,notes='',extra={})=>({id,name,members,reaction,why,notes,confidence:'Reviewed',provenance:'source-informed',source,iansanBuild:'movement-atk-support',...extra});
const c4={constraints:{iansanMinConstellation:4},movementAssumption:'Iansan C4 assists buff maintenance for this lower-movement driver'};
export const IANSAN_REVIEWED_TEAMS=[
  team('iansan-varesa-xianyun-furina','Varesa Hypercarry',['Iansan','Varesa','Xianyun','Furina'],'','Varesa naturally moves and plunges enough to maintain Iansan’s ATK buff while Xianyun heals/buffs Plunges and sustains Furina Fanfare.','Iansan is not the Furina sustain.'),
  team('iansan-varesa-xianyun-bennett','Varesa Double Buffer',['Iansan','Varesa','Xianyun','Bennett'],'','Iansan and Bennett stack ATK support while Xianyun supplies Plunge support/healing and Varesa easily satisfies Iansan’s movement requirement.'),
  team('iansan-varesa-mavuika-chevreuse','Varesa Chevreuse · Mavuika',['Iansan','Varesa','Mavuika','Chevreuse'],'overload','All four characters are Electro/Pyro, preserving Chevreuse’s passive while Varesa’s mobility maintains Iansan’s buff.','Pure Pyro/Electro roster.'),
...
export default IANSAN_REVIEWED_TEAMS;