...
export const CYNO_REVIEWED_TEAMS=[
  ...
  team('cyno-game8-aggravate-fischl-nahida-baizhu','Aggravate · Fischl/Nahida/Baizhu',['Cyno','Fischl','Nahida','Baizhu'],'aggravate','Game8 exact Aggravate team; KQM independently supports the same Double Dendro + Double Electro composition.',{...game8(),links:[game8(),kqm()]}),
